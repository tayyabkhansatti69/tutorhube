...
// import { useGetJobExternalBoardsQuery } from "@services/configuration/job-boards/job-boards-external";

// export function HeroSection(props: any): JSX.Element {
//   const { boardName } = props;
//   const { data } = useGetJobExternalBoardsQuery({
//     params: {
//       boardDomainName: boardName,
//     },
//   });
