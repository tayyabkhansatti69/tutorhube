...
import LessonCard from './upComingLesson';

function MyLessonSection() {
    ...
    return (
        ...
        <Grid px={4} pt={7} spacing={2} container >
            <Paper variant="elevation" sx={{ p: 2 }} elevation={2}>
                <Box pt={1} pb={2} display={'flex'} justifyContent={'flex-start'} alignItems={'center'} flexDirection={'row'} gap={2}>
                    <IconButton sx={{ cursor: 'ointer' }} onClick={() => { router.push('/studentDashboard') }}><ArrowBackIcon /></IconButton>
                    <Typography variant='h6' fontWeight={'bold'}>Upcoming Lesson</Typography>
                </Box>

                <LessonCard />
                <Grid pt={1} spacing={2} container mt={2} flexDirection={'row'} alignItems={'center'} display={'flex'} justifyContent={'flex-start'}>
...
export default MyLessonSection
