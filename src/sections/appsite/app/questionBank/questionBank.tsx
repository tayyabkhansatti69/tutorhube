    ...
    const quizData = {
        questions: [
            ...
            },
            {
                ...
                question: 'She is 28 year old',
                answer: ['To live', 'To have food', 'To be living'],
            },
            {
                id: 3,
                type: 'trueFalse',
                        ...
                        <Grid2 container spacing={2} padding={'16px'}>
                            ...
                            <Grid2 size={{ xs: 12, md: 6 }} mt={3}>
                                <Box display={'flex'} justifyContent={'flex-end'} flexDirection={'row'} alignItems={'center'} gap={2}>
                                    <Button variant="contained" sx={{ background: "#9CA3AF" }} startIcon={<AddIcon sx={{ color: 'white', background: "#9CA3AF" }} />}>
                                        Add A Question
                                    </Button>
